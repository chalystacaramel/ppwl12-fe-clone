...
Class A / Team 1 Live site: https://kelompoksatu.ct.ws  
Main Web: notion.com

|        Name       |    NIM     | Reference Page | Spesific Component |
|-------------------|------------|----------------|--------------------|
| **Adhelia Issabel** | H110124001 | [Page 2 — Pricing](https://www.notion.com/pricing) | `FAQ.tsx`<br>`PlansAndFeatures.tsx`<br>`PricingCards.tsx`<br>`PricingFooter.tsx`<br>`PricingHeader.tsx`<br>`PricingPage.tsx`<br>`PricingToggle.tsx`<br>`Testimonial.tsx` |
