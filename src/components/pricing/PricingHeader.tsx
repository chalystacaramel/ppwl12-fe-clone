export function PricingHeader() {
  return (
    <>
      {/* Top Banner */}
      <div className="bg-white border-b border-gray-100 py-3 px-6 flex items-center justify-between text-sm">
        <div className="flex items-center gap-2">
          <span className="text-gray-700">
            Developers: Get a first look at our new Developer Platform on May 13.
          </span>
          <a href="#" className="text-[#0a85d1] hover:underline flex items-center gap-1">
            Register today
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
        <nav className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="#" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Teams</a>
            <a href="#" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Individuals</a>
            <a href="#" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Download</a>
            <a href="/pricing" className="text-gray-900 hover:text-gray-900 text-sm font-semibold">Pricing</a>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="bg-[#0a85d1] hover:bg-[#0976ba] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
              Get Notion free
            </a>
